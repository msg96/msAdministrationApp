...
"")
        ...
        self.ToggleLeftBtn.setFocusPolicy(Qt.NoFocus)
        self.ToggleLeftBtn.setContextMenuPolicy(Qt.NoContextMenu)
        icon = QIcon()
        ...
        self.ToggleRightBtn.setFocusPolicy(Qt.NoFocus)
        self.ToggleRightBtn.setContextMenuPolicy(Qt.NoContextMenu)
        icon4 = QIcon()
        ...
        self.horizontalLayout_14 = QHBoxLayout(self.page_2)
